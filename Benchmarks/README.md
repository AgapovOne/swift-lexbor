...
| SwiftLexbor | 15.0 µs | 14.9 µs | 16.8 µs |
...
| SwiftLexbor | 27.8 µs | 26.5 µs | 30.3 µs |
...
| SwiftLexbor | 312.3 µs | 311.5 µs | 326.0 µs |
...
On an 81 KB document, SwiftLexbor (lexbor) parses in **311.5 µs** — **12x faster** than JustHTML/SwiftSoup/BonMot and **295x faster** than NSAttributedString. Raw C API overhead for Swift AST conversion is ~2x.
